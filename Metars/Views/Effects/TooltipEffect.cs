...
namespace Metars.Views.Effects
{
    ...
    internal class ControlTooltipEffect : RoutingEffect
    {
        public ControlTooltipEffect() : base("MyApps.TooltipEffect")
        {
