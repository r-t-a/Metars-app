...
namespace UnitTests
{
    internal class MockRuntimePlatformService : IPlatformServices
    {
        Action<Action> _invokeOnMainThread;
        Action<Uri> _openUriAction;
        Func<Uri, CancellationToken, Task<Stream>> _getStreamAsync;
        public MockRuntimePlatformService(Action<Action> invokeOnMainThread = null, Action<Uri> openUriAction = null, Func<Uri, CancellationToken, Task<Stream>> getStreamAsync = null)
        {
        ...
        public AppTheme RequestedTheme => throw new NotImplementedException();

        OSAppTheme IPlatformServices.RequestedTheme => throw new NotImplementedException();
    ...
    internal class MockDeviceInfo : Xamarin.Forms.Internals.DeviceInfo
    {
    ...
    public static class MockForms
    {
        public static void Init()
        {
            ...
            Device.PlatformServices = new MockRuntimePlatformService();
